...
export default class extends BaseComponent {
  ...
  connectedCallback() {
    ...
    this.$programs = [];
    fetch(
        "https://data.travel-dealz.eu/api/airline_programs?filter[has_qualification]=true&fields[airline_programs]=code,name,alliance,qualification"
    )
  ...
  display({ value: data, program, airports }, totals) {
    super.display();
