...
export default class extends BaseComponent {
    ...
    connectedCallback() {
        ...
        this.$programs = [];
        fetch(
            "https://data.travel-dealz.eu/api/airline_programs?include=airlines&filter[has_qualification]=true&fields[airline_programs]=code,name,alliance,qualification&fields[airlines]=iatacode,name,alliance,airline_program_code"
        )
